...
@section('title','Edit Listing Pengiriman ')
                        ...
                        <div class="table-responsive">
                                <form action="{{route('pengirim.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <label for="no_pengiriman">Nomor Pengiriman</label>
                                        <input type="text" class="form-control " name="no_pengiriman"id="text" value="{{$pengirim->no_pengiriman}}" required>
                                    </div>
                                    <div class="form-group">
                                    <label for="tanggal">Date</label>
                                        <input type="date" class="form-control" id="text"name="tanggal"  value="{{$pengirim->tanggal}}"  required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     <label for="lokasi">lokasi</label>
                                        <select class="form-control" name="lokasi_id">
                                            @foreach($lok as $lk)
                                            <option value="{{$lk->id}}">{{$lk->nama_lokasi}}   {{$pengirim->nama_lokasi}} </option>
                                ...
                                <div class="form-group">
                                     <label for="barang">Barang</label>
                                        ...
                                        <input type="text" class="form-control" id="number"name="jumlah_barang"  value="{{$pengirim->jumlah_barang}}"  placeholder="" required>
                                      </div>
                               
                                    </div>
                                        <div class="form-group">
                                        <label for="harga_barang">Harga Barang</label>
                                        <input type="text" class="form-control" id="text"name="harga_barang" value="{{$pengirim->harga_barang}}" placeholder="Harga Barang" required>
                                      </div>
